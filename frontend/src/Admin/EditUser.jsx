...
import { updateUser } from './AuthServieAdmin';
...
function EditUser({userId}) { 
  ...
  const handleSubmit = async  (e) => {
    ...
    const {success, message} = await updateUser(formDataUser, userId);

    if (success){
      setMessage("User updated successfully!");
    } else {
      setMessage( message ||"Failed to update user. Please try again.")
    }
